...
export function RecipientsStep({
    ...
    return (
      <section className="flex flex-col gap-5">
        <div className="flex flex-col gap-1">
          <h2 className="text-2xl font-semibold text-brand-ink">Recipient</h2>
  ...
  return (
    <section className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        <h2 className="text-2xl font-semibold text-brand-ink">Recipients</h2>
        <p className="text-brand-muted">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <p className="text-sm text-brand-muted">
          <strong className="text-brand-ink">{recipients.length}</strong> recipient
        ...
        <button
          type="button"
          onClick={add}
          className="rounded-md border border-brand-berry px-4 py-2 text-sm font-medium text-brand-berry transition hover:bg-brand-berry hover:text-white"
        >
          + Add recipient
        </button>
      </div>
      ...
      {recipients.length === 0 ? (
        <p className="rounded-lg border border-dashed border-brand-sand bg-white p-6 text-center text-sm text-brand-muted">
